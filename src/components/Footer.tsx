...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-900 text-white pt-12 pb-8" dir={direction}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <motion.div
            ...
            className="space-y-4"
          >
            <h3 className="text-xl font-semibold mb-4 text-blue-400">Insurance Co.</h3>
            <p className="text-gray-400">
              Providing reliable insurance solutions for individuals and businesses for over 25 years.
            </p>
            <div className="pt-2">
              <p className="text-gray-400">License #: 12345-ABC</p>
              <p className="text-gray-400">Tax ID: 987-654-321</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="flex items-start space-x-3 text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mt-0.5 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
              </svg>
              <span>1234 Insurance Street, City Name, Country</span>
            </p>
            ...
            <p className="flex items-center space-x-3 text-gray-400">
              ...
              <span>info@insurancecompany.com</span>
            </p>
          </motion.div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 text-center text-gray-400 text-sm">
          <p>&copy; {new Date().getFullYear()} Insurance Company. {t('footer.allRightsReserved')}</p>
